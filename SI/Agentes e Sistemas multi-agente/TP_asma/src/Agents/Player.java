...
public class Player extends Agent {
    ...
    private Position targetPos; //(indicates where the robot is going next)
    private int score;
        ...
        public void action() {
            ...
            if (msg != null &&  msg.getPerformative() == ACLMessage.CONFIRM) {
                ...
                if (!msg.getContent().equals("Invalid Move")) {
                    ...
                    //myAgent.addBehaviour(new Movement(myAgent, 1000));
    ...
    public class Movement extends TickerBehaviour {
        ...
        public void onTick() {
            if(!waiting) {
                ...
                if(inimigos==1 && amigos > 0) {
                    //ataque
                    //myAgent.addBehaviour(new Attacker(myAgent));
                }
                else if(inimigos>1 && amigos == 0) {
                    //defesa
